...
<div class="account-navi-content">
  ...
  <div class="row">
    ...
    <h3 class="panel-title"> Engaged Jobs | Client name displayed next to Job title | Start submitting candidates by using the action button and earn 2X faster | Read the Best Practices before submitting any candidate -> <a href="https://www.recruitinghub.com/bestpractices-recruiter" target=_blank><i class="btn-primary fa fa-fw fa-search"></i> <b>BEST PRACTICES</b></a></h3>
  </header>
