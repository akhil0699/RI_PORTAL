...
$engagedmsg="You have no pending requests or they may be already auto approved";
?>
<!doctype html>
<html>
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Requests | Employers Hub</title>
  ...
  <div class="tab-content">
    ...
    <section class="main-content-wrapper">
      <div class="pageheader pageheader--buttons">
          <div class="row">
            <div class="col-md-12">
              <h4>List of Requests from Agencies | All your Contract jobs / 0-15 Yrs Permanent Jobs / Agencies you added on your PSL gets auto approved <br><span class="label label-primary">NO ACTION REQUIRED FROM YOU IF THE POSTED JOBS ARE 0-15 YEARS EXP PERMANENT OR CONTRACT.</span></h4>
            </div>
            <div class="col-md-12">
...
<div class="col-sm-6">
     <form method="post" action="requests">
       <div class="form-group">
        ...
        <!--<label>Search List</label><br>-->
        <div class="col-sm-8 no-padding">
        	<input name="jobtitle" class="form-control ui-autocomplete-input" id="jobtitle" placeholder="Search by Job Title" autocomplete="off" type="text">
        </div>
      ...
      <ul class="dropdown-menu dropdown-menu--right" role="menu">
	  	 	<li><a class="btn"   onclick="submitForm('approve-requestall')" id="shortlist">Approve</a></li>
			<li><a  class="btn"  onclick="submitForm('reject-requestall')" id="screenreject"> Reject</a></li>
                ...
                <table class="table table-striped jobs-list">
                  <thead>
                    <tr>
                      <th>
                        Job Title/Location /Post Date</th>

                      <th>Request from Agency</th>
                      <th>Actions</th>
	    ...
	    foreach($engagedarray as $row){
			echo'
          <tr>
  <td><input type="checkbox"  value='.$row['requestid'].' name="allcheck[]"><a class="title" href="#" data-toggle="modal" data-target="#engage-modal" id='.$row['jobid'].'>'.$row['jobtitle'].'</a> <br>
   <small>'.$row['joblocation'].'</small> /  <small>Added: '.$row['postdate'].'</small> </td>
 <td><a class="title" href="#" data-toggle="modal" data-target="#recruiter-modal" id='.$row['id'].'>'.$row['recruitername'].' / '.$row['companyname'].'</a></td>
  <td>
    <div class="btn-group">
      <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
        Action <span class="caret"></span>
