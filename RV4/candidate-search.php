...
<p><span class="style6"><strong>Current Location: </strong></span><?php echo $row['country'];?>, <?php echo $row['city'];?> | <strong>Notice Period:</strong> </span> <?php echo $row['noticeperiod'];?> | <strong>Register Date:</strong> </span> <?php echo $row['registereddate'];?></p>
