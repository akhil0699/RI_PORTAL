        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            ...
            color: #a02121;">  PLEASE DO NOT REPLY TO THIS EMAIL AS EMAILS ARE NOT MONITORED FOR THIS EMAIL ID. LOGIN TO YOUR ACCOUNT TO RESPOND AS APPROPRIATE </p>   
					  ...
					  <p>Your candidate <strong>'.$namerow1['fname'].'</strong> submitted for <strong>'.$fetchjtitle.'</strong> has been <strong>'.$statusres.'</strong> by <strong>'.$fetchempname['name'].'</strong> for reason - <strong>'.$comment.'</strong></p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
                   ...
                   Dear '.$fetchname2['fname'].',
                      <p>Greetings from <a href="https://www.recruitinghub.com/">www.recruitinghub.com</a></p>
					  <p>Your profile <strong>'.$namerow1['fname'].'</strong> submitted by <strong>'.$fetchrecname['name'].'</strong> for <strong>'.$fetchjtitle.'</strong> has been <strong>'.$statusres.'</strong> by Employer <strong>'.$fetchempname['name'].'</strong> for reason - <strong>'.$comment.'</strong></p>
