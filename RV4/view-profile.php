...
<li><a href="https://www.recruitinghub.com/flexirecruiter" target=_blank role="tab" > <i class="fa fa-database"></i>Flexi Recruiter <span class="label label-primary">New</span></a> </li>
...
<h5> <?php echo $job['jobtitle']; ?></h5>
 ...
 <td>
Job Status -> <?php echo $job['status']; ?>  
</td>
<td>
<?php if(!$isengaged) 
...
<tr>
    ...
    <td>Keeping it between you (Vendor) and Employer (Client) with no more need for a middle man, you can now "Message Employer" directly after clicking Engage button for clarification (if any) about this role. Click "Add Notes" after submitting your candidate to follow up on feedbacks. An email notification will automatically be sent to the registered email id of the client copying the Account Manager of this client.
