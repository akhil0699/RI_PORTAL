...
$errorMsg='<p style="
            font-size: 14px;
            color: #a02121;
        ">Your recruiter account has been restricted! Follow this link -><b><a href="https://www.recruitinghub.com/recruiterrestrictedaccount" target="_blank">CLICK HERE</a></b></p>';
}
}
else
...
<title>Recruiter Login Hub</title>
...
<p class="text-center"><img src="../lia_img/office_building.svg" width="40px" class="box_img"></p>
<p class="box_txt">Access to top companies & clients.</p>
</div>
</div>
</div>
<div class="col-md-6">
...
<p class="text-center"><img src="../lia_img/fees.svg" width="40px" class="box_img"></p>
<p class="box_txt">No Subscription fee</p>
</div>
</div>
</div>
</div>
...
<p class="text-center"><img src="../lia_img/teamwork.svg" width="40px" class="box_img"></p>
<p class="box_txt">Supply Candidates | Earn Money</p>
</div>
</div>
</div>
<div class="col-md-6">
...
<p class="text-center"><img src="../lia_img/cv.svg" width="40px" class="box_img"></p>
<p class="box_txt">Post Jobs & Search CV’s for Free</p>
</div>
</div>
</div>
</div>
...
<p class="text-center"><img src="../lia_img/rating.svg" width="50px" class="box_img"></p>
<p class="box_txt">Improve your agency rating</p>
</div>
</div>
</div>
<div class="col-md-6">
...
<p class="text-right">Don’t have Vendor Account? <a href="https://www.recruitinghub.com/signup-recruitment-agency">Sign up</a> </p>
</div>

<div class="col-12 col-md-9">
<div class="signup_sec">
<p class="text-right">Employer? <a href="https://www.recruitinghub.com/employer/login">Login</a> </p>
</div>

</div>
</div></div>

<h5>As Recruitment Vendor</h5>
<!--<p>Develop your recruitment business through us</p>-->
...
<div class="form-group">
<label>E-mail</label>
<input name="email" class="form-control" type="email" required placeholder="Enter your Agency Email id"/>
</div>
<div class="form-group">
