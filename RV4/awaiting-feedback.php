...
$sql = "
	SELECT 
		...
		c.viewnotes,c.submitdate,c.candidateid as candidateid,d.name,c.viewed,c.viewedtime,c.employernotes,c.amnotes,c.comment,c.id as sid
	FROM 
...
<div class="table-responsive">
 ...
 <b>No feedback yet? Click Open the CV and click "<b>Add Notes</b>" to follow up with Client (Please be polite to clients when chasing for feedback)</b>
</div>
