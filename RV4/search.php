 ...
 <h3>Total Available Live Roles:<?php echo $total; ?></h3>
  ...
  <div class="row">
              <div class="col-md-12 table-responsive">
               <div class="panel panel-default">
                <header class="panel-heading wht-bg ui-sortable-handle">
    <h3 class="panel-title"> Jobs posted by Employers (SUPPLY CANDIDATES AND EARN 2X FASTER) | NO SUBSCRIPTION FEE | <a href="https://www.recruitinghub.com/bestpractices-recruiter" target=_blank><i class="btn-primary fa fa-fw fa-search"></i> <b>BEST PRACTICES</b></a></h3>
  </header>
        <div class="panel-body">
               <?php if(!$content){ ?>
