...
if(isset($_POST['jobtitle']) && ($_POST['jobtitle']!='')  && isset($_POST['employer']) && ($_POST['employer']!='') && isset($_POST['candidate']) && ($_POST['candidate']!='')){
	...
	$sql = "
	SELECT 
		a.jobid,a.status as jobstatus,a.jobtitle as jobtitle,	a.memberid, b.id, b.fname as fname, b.contactnumber,b.cv as cv,b.jobtype,b.desiredsalary,b.expectedcurrency,b.typesalary,b.currentjobtitle,c.status as candidatestatus,c.viewnotes,c.viewed,c.viewedtime,c.employernotes,c.amnotes,c.comment,c.submitdate,c.candidateid as candidateid,d.name
	FROM 
...
elseif(isset($_POST['jobtitle']) && ($_POST['jobtitle']=='')  && isset($_POST['employer']) && ($_POST['employer']=='') && isset($_POST['candidate']) && ($_POST['candidate']!='')){
	...
	$sql = "
	SELECT 
		a.jobid,a.status as jobstatus,a.jobtitle as jobtitle,	a.memberid, b.id, b.fname as fname, b.contactnumber,b.cv as cv,b.jobtype,b.desiredsalary,b.expectedcurrency,b.typesalary,b.currentjobtitle,c.status as candidatestatus,
		c.viewnotes,c.viewed,c.viewedtime,c.employernotes,c.amnotes,c.comment,c.submitdate,c.candidateid as candidateid,d.name
	FROM 
		submitted_candidates c,	jobs a,	candidates b, companyprofile d, members e 
	WHERE 
		a.jobid=c.jobid and b.id=c.candidateid and c.status='Shortlisted' and e.memberid=a.memberid and 
...
$candidatemsg="No shortlisted candidates yet.";
?>
<!doctype html>
<html>
<head>
              ...
              <thead>
                <tr>
                  <th>Candidate Name / ID</th>
                   <th>Job Title / Job ID / Employer/ Job Status</th>
                  <th>Phone</th>
