...
$rcountry=$_SESSION['country'];
	...
	elseif(isset($_POST['submit'])){
		...
		$q3=mysqli_query($link,"select a.fname,a.id,a.email  from candidates a where a.id='$candidateid'");
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td><p>
                            ...
                            <br>
                            Your CV has been submitted by <strong>'.$array2['name'].'</strong> for the Company <strong>'.$array1['name'].'</strong> for the <strong>'.$array1['jobtype'].'</strong> position <strong>'.$array1['jobtitle'].'</strong> in <strong>'.$array1['joblocation'].'</strong><br>
                            <br>
...
<table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#000" align="center" bgcolor="#792785" border="0" cellpadding="0" cellspacing="0" width="620">
                                                  ...
                                                  <td valign="top"><table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                      <tr>
                                                        <td><p><br>
                                                          ...
                                                          <br>
                                                          You have received CV of <strong>'.$array3['fname'].'</strong> for <strong>'.$arr1['jobtitle'].' - </strong> <strong>'.$arr1['jobtype'].'</strong> job in <strong>'.$arr1['joblocation'].'</strong> from <strong>'.$array2['name'].'</strong><br>
                                                          <br>
                                                          ...
                                                          <br>
                                                          Please use our live chat widget to communicate directly with our team or the messaging system to communicate with the agency that submitted this profile. 
 ...
 <tr>
  ...
  AsyncMail($params);		
			...
			echo "<script>
alert('CV Submission Successful. Software has emailed both Client & Candidate a notification about the submission. Please insist your candidate to check their email both inbox/spam folder.');
window.location.href='awaiting-feedback.php';
</script>";
	                    exit();
							}else{
							//$row=mysqli_fetch_assoc($duplicate);
							$content="Duplicate CV! You could not submit this CV as the same candidate has been submitted for this job by another agency.";
						}
					}
				else
				$content="You could not submit a candidate as the submission is above the CV limit. Please message the Employer to increase CV limit for this Job or use the live chat to talk to us";
			}	
			else
			$content="Sorry, you cannot submit further cv's as all the vacancies are filled for this job.";
		}
		else
		$content="You have already submitted this candidate for this job. You may be using same email id for all candidates submission specific to this job id. Edit Candidate Email ID and try submitting again. To do this go to -> SUPPLY CANDIDATES (STS) -> Click Action button and Click Edit Profile";	
	}		
	else
  ...
  <div class="tab-content">
    ...
    <section class="main-content-wrapper">
      <div class="pageheader pageheader--buttons">
          <div class="row">
            <div class="col-md-6">
    <h4>Cover Letter (Final stage of submitting your candidate to the engaged job)</h4> You are submitting Candidate ID - <b><?php echo $candidateid;?></b> for Job ID <b><?php echo $jobid;?></b>
            </div>
            <div class="col-md-6">
