 ...
 <div class="col-xs-12">
      <section class="panel panel-default">
        <header class="panel-heading panel-heading--buttons wht-bg">
          <h4 class="gen-case">Feedback Rating || Add/Remove PSL || Add/Remove Blocking ||| <a href="psl-list">PSL List</a> | <a href="block-list">Block List</a></h4>
        ...
        <div class="panel-body minimal">			
          <div class="table-responsive ">
			<table class="table table-striped">
              <thead>
                <tr>
               <th> <div class="checkbox"><label><input value="1" name="allcandi" type="checkbox" id="select-all">Select All</label></div>
         </div></th>
